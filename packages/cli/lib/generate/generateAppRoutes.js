...
function generateAppConfig() {
    return __awaiter(this, void 0, void 0, function () {
        var baseDoc, componentsDoc, baseDocsRoutes, componentDocsRoutes, source, configPath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    baseDocsRoutes = baseDoc.map(function (docPath) {
                        var _a = getRouteConfig(docPath), path = _a.path, meta = _a.meta;
                        return "\n  {\n    path: '".concat(path, "',\n    component: () => import('").concat(docPath, "'),\n    meta: {\n      parent: '").concat(meta.parent, "'\n    }\n  }");
                    });
                    componentDocsRoutes = componentsDoc.map(function (docPath) {
                        var _a = getRouteConfig(docPath), path = _a.path, meta = _a.meta;
                        return "\n  {\n    path: '".concat(path, "',\n    component: () => import('").concat(docPath, "'),\n    meta: {\n      parent: '").concat(meta.parent, "'\n    }\n  }");
                    });
                    source = "export default [    ".concat(baseDocsRoutes, ",\n    ").concat(componentDocsRoutes, "\n]");
                    configPath = (0, path_1.resolve)(process.cwd(), 'site/pc/route.ts');
